...
<head>
	...
	<title>Charlie McMahon / Macca™ - Portfolio</title>
		...
		<div class="container opened" data-animation-in="fadeInLeft" data-animation-out="fadeOutLeft">
			...
			<header class="header">
				...
				<div class="profile">						
					...
					<div class="title">Charlie McMahon</div>
			...
			<div class="card-started" id="home-card">
				...
				<div class="profile">
					...
					<!-- profile socials -->
					<div class="social">
						<a target="_blank" href="https://discord.bio/p/macca"><span class="fa fa-discord"></span></a>
						<a target="_blank" href="https://twitter.com/charliekmcmahon"><span class="fa fa-twitter"></span></a>
						<a target="_blank" href="https://github.com/charliekmcmahon"><span class="fa fa-github"></span></a>
						<a target="_blank" href="https://open.spotify.com/user/cmcma79?si=De2GziSTQ2qhhrQ-XLGrOQ"><span class="fa fa-spotify"></span></a>
					</div>
					...
					<div class="content about">
						...
						<div class="row">
							<div class="col col-d-6 col-t-6 col-m-12 border-line-v">
								<div class="text-box">
									<p>
										I'm Charlie, developer & designer from Queensland, Australia. I have rich experience in 
										website design building and customization, and I also love do get my hands dirty and start new projects with groups of people. 
									</p>
								</div>
							</div>
							<div class="col col-d-6 col-t-6 col-m-12 border-line-v">
								<div class="info-list">
									<ul>
										...
										<li><strong>Alias . . . . .</strong> Macca™</li>
