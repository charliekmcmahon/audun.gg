...
<script language="JavaScript">
  ...
  function confirm_prompt(text) {
    ...
    if (confirm(text)) {
      ...
      window.location = 'adminthursday.php?update=clear';
    ...
    if (confirm(text)) {
      ...
      window.location = 'adminthursday.php?update=ra';
    ...
    if (confirm(text)) {
      ...
      window.location = 'adminthursday.php?update=rb';
    ...
    if (confirm(text)) {
      ...
      window.location = 'adminthursday.php?update=rc';
    ...
    if (confirm(text)) {
      ...
      window.location = 'adminthursday.php?update=rd';
    ...
    if (confirm(text)) {
      ...
      window.location = 'adminthursday.php?update=re';
    ...
    if (confirm(text)) {
      ...
      window.location = 'adminthursday.php?update=rf';
    ...
    if (confirm(text)) {
      ...
      window.location = 'adminthursday.php?update=rg';
    ...
    if (confirm(text)) {
      ...
      window.location = 'adminthursday.php?update=rx';
    ...
    if (confirm(text)) {
      ...
      window.location = 'adminthursday.php?update=rh';
    ...
    if (confirm(text)) {
      ...
      window.location = 'adminthursday.php?update=ri';
    ...
    if (confirm(text)) {
      ...
      window.location = 'adminthursday.php?update=rj';
    ...
    if (confirm(text)) {
      ...
      window.location = 'adminthursday.php?update=rk';
    ...
    if (confirm(text)) {
      ...
      window.location = 'adminthursday.php?update=rl';
    ...
    if (confirm(text)) {
      ...
      window.location = 'adminthursday.php?update=rm';
    ...
    if (confirm(text)) {
      ...
      window.location = 'adminthursday.php?update=rn';
    ...
    if (confirm(text)) {
      ...
      window.location = 'adminthursday.php?update=ro';
    ...
    if (confirm(text)) {
      ...
      window.location = 'adminthursday.php?update=rp';
    ...
    if (confirm(text)) {
      ...
      window.location = 'adminthursday.php?update=rq';
    ...
    if (confirm(text)) {
      ...
      window.location = 'adminthursday.php?update=rr';
    ...
    if (confirm(text)) {
      ...
      window.location = 'adminthursday.php?update=rs';
    ...
    if (confirm(text)) {
      ...
      window.location = 'adminthursday.php?update=rt';
    ...
    if (confirm(text)) {
      ...
      window.location = 'adminthursday.php?update=ru';
    ...
    if (confirm(text)) {
      ...
      window.location = 'adminthursday.php?update=rv';
    ...
    if (confirm(text)) {
      ...
      window.location = 'adminthursday.php?update=rw';
...
<p align="left" class="heading"><font face="Verdana" size="1"><u><b>Book Your Thursday Shows</b></u></p></font>
...
cellpadding="2" cellspacing="0">
    ...
    <tr>
      ...
      <td width=100 align="center"><font face="Verdana" size="1">00:00 - 01:00</font></td>
		...
		echo"<a href=adminthursday.php?update=a>&nbsp;Book this Slot</a>";
	...
	<tr>
      ...
      <td width=100 align="center"><font face="Verdana" size="1">01:00 - 02:00</font></td>
		...
		echo"<a href=adminthursday.php?update=b>&nbsp;Book this Slot</a>";
	...
	<tr>
      ...
      <td width=100 align="center"><font face="Verdana" size="1">02:00 - 03:00</font></td>
		...
		echo"<a href=adminthursday.php?update=c>&nbsp;Book this Slot</a>";
	...
	<tr>
      ...
      <td width=100 align="center"><font face="Verdana" size="1">03:00 - 04:00</font></td>
		...
		echo"<a href=adminthursday.php?update=d>&nbsp;Book this Slot</a>";
	...
	<tr>
      ...
      <td width=100 align="center"><font face="Verdana" size="1">04:00 - 05:00</font></td>
		...
		echo"<a href=adminthursday.php?update=e>&nbsp;Book this Slot</a>";
	...
	<tr>
      ...
      <td width=100 align="center"><font face="Verdana" size="1">05:00 - 06:00</font></td>
		...
		echo"<a href=adminthursday.php?update=f>&nbsp;Book this Slot</a>";
	...
	<tr>
      ...
      <td width=100 align="center"><font face="Verdana" size="1">06:00 - 07:00</font></td>
		...
		echo"<a href=adminthursday.php?update=g>&nbsp;Book this Slot</a>";
	...
	<tr>
      ...
      <td width=100 align="center"><font face="Verdana" size="1">07:00 - 08:00</font></td>
		...
		echo"<a href=adminthursday.php?update=x>&nbsp;Book this Slot</a>";
	...
	<tr>
      ...
      <td width=100 align="center"><font face="Verdana" size="1">08:00 - 09:00</font></td>
		...
		echo"<a href=adminthursday.php?update=h>&nbsp;Book this Slot</a>";
	...
	<tr>
      ...
      <td width=100 align="center"><font face="Verdana" size="1">09:00 - 10:00</font></td>
		...
		echo"<a href=adminthursday.php?update=i>&nbsp;Book this Slot</a>";
	...
	<tr>
      ...
      <td width="100" align="center"><font face="Verdana" size="1">10:00 - 11:00</font></td>
		...
		echo"<a href=adminthursday.php?update=j>&nbsp;Book this Slot</a>";
	...
	<tr>
      ...
      <td width=100 align="center"><font face="Verdana" size="1">11:00 - 12:00</font></td>
		...
		echo"<a href=adminthursday.php?update=k>&nbsp;Book this Slot</a>";
	...
	<tr>
      ...
      <td><font face="Verdana" size="1"><?php if($l == ''){
		...
		echo"<a href=adminthursday.php?update=l>&nbsp;Book this Slot</a>";
	...
	<tr>
	  ...
	  <td><font face="Verdana" size="1"><?php if($m == ''){
		...
		echo"<a href=adminthursday.php?update=m>&nbsp;Book this Slot</a>";
	...
	<tr>
      ...
      <td><font face="Verdana" size="1"><?php if($n == ''){
		...
		echo"<a href=adminthursday.php?update=n>&nbsp;Book this Slot</a>";
	...
	<tr>
      ...
      <td><font face="Verdana" size="1"><?php if($o == ''){
		...
		echo"<a href=adminthursday.php?update=o>&nbsp;Book this Slot</a>";
	...
	<tr>
      ...
      <td><font face="Verdana" size="1"><?php if($p == ''){
		...
		echo"<a href=adminthursday.php?update=p>&nbsp;Book this Slot</a>";
	...
	<tr>
      ...
      <td><font face="Verdana" size="1"><?php if($q == ''){
		...
		echo"<a href=adminthursday.php?update=q>&nbsp;Book this Slot</a>";
	...
	<tr>
      ...
      <td width=100 align="center"><font face="Verdana" size="1">18:00 - 19:00</font></td>
		...
		echo"<a href=adminthursday.php?update=r>&nbsp;Book this Slot</a>";
	...
	<tr>
      ...
      <td><font face="Verdana" size="1"><?php if($s == ''){
		...
		echo"<a href=adminthursday.php?update=s>&nbsp;Book this Slot</a>";
	...
	<tr>
      ...
      <td><font face="Verdana" size="1"><?php if($t == ''){
		...
		echo"<a href=adminthursday.php?update=t>&nbsp;Book this Slot</a>";
	...
	<tr>
      ...
      <td width=100 align="center"><font face="Verdana" size="1">21:00 - 22:00</font></td>
		...
		echo"<a href=adminthursday.php?update=u>&nbsp;Book this Slot</a>";
	...
	<tr>
      ...
      <td width=100 align="center"><font face="Verdana" size="1">22:00 - 23:00</font></td>
		...
		echo"<a href=adminthursday.php?update=v>&nbsp;Book this Slot</a>";
	...
	<tr>
      ...
      <td width=100 align="center"><font face="Verdana" size="1">23:00 - 00:00</font></td>
		...
		echo"<a href=adminthursday.php?update=w>&nbsp;Book this Slot</a>";
...
$check = mysql_query("SELECT a FROM thursday WHERE id='1'");

if (!$check == ''){

mysql_query("UPDATE thursday SET a='$user'");

echo "<script language=\"javascript\">

<!-- 

location.replace(\"adminthursday.php\");
...
$check = mysql_query("SELECT b FROM thursday WHERE id='1'");

if (!$check == ''){

mysql_query("UPDATE thursday SET b='$user'");
...
$check = mysql_query("SELECT c FROM thursday WHERE id='1'");

if (!$check == ''){

mysql_query("UPDATE thursday SET c='$user'");
...
$check = mysql_query("SELECT d FROM thursday WHERE id='1'");

if (!$check == ''){

mysql_query("UPDATE thursday SET d='$user'");
...
$check = mysql_query("SELECT e FROM thursday WHERE id='1'");

if (!$check == ''){

mysql_query("UPDATE thursday SET e='$user'");
...
$check = mysql_query("SELECT f FROM thursday WHERE id='1'");

if (!$check == ''){

mysql_query("UPDATE thursday SET f='$user'");
...
$check = mysql_query("SELECT g FROM thursday WHERE id='1'");

if (!$check == ''){

mysql_query("UPDATE thursday SET g='$user'");
...
$check = mysql_query("SELECT x FROM thursday WHERE id='1'");

if (!$check == ''){

mysql_query("UPDATE thursday SET x='$user'");
...
$check = mysql_query("SELECT h FROM thursday WHERE id='1'");

if (!$check == ''){

mysql_query("UPDATE thursday SET h='$user'");
...
$check = mysql_query("SELECT i FROM thursday WHERE id='1'");

if (!$check == ''){

mysql_query("UPDATE thursday SET i='$user'");
...
$check = mysql_query("SELECT j FROM thursday WHERE id='1'");

if (!$check == ''){

mysql_query("UPDATE thursday SET j='$user'");
...
$check = mysql_query("SELECT k FROM thursday WHERE id='1'");

if (!$check == ''){

mysql_query("UPDATE thursday SET k='$user'");
...
$check = mysql_query("SELECT l FROM thursday WHERE id='1'");

if (!$check == ''){

mysql_query("UPDATE thursday SET l='$user'");
...
$check = mysql_query("SELECT m FROM thursday WHERE id='1'");

if (!$check == ''){

mysql_query("UPDATE thursday SET m='$user'");
...
$check = mysql_query("SELECT n FROM thursday WHERE id='1'");

if (!$check == ''){

mysql_query("UPDATE thursday SET n='$user'");
...
$check = mysql_query("SELECT o FROM thursday WHERE id='1'");

if (!$check == ''){

mysql_query("UPDATE thursday SET o='$user'");
...
$check = mysql_query("SELECT p FROM thursday WHERE id='1'");

if (!$check == ''){

mysql_query("UPDATE thursday SET p='$user'");
...
$check = mysql_query("SELECT q FROM thursday WHERE id='1'");

if (!$check == ''){

mysql_query("UPDATE thursday SET q='$user'");
...
$check = mysql_query("SELECT r FROM thursday WHERE id='1'");

if (!$check == ''){

mysql_query("UPDATE thursday SET r='$user'");
...
$check = mysql_query("SELECT s FROM thursday WHERE id='1'");

if (!$check == ''){

mysql_query("UPDATE thursday SET s='$user'");
...
$check = mysql_query("SELECT t FROM thursday WHERE id='1'");

if (!$check == ''){

mysql_query("UPDATE thursday SET t='$user'");
...
$check = mysql_query("SELECT u FROM thursday WHERE id='1'");

if (!$check == ''){

mysql_query("UPDATE thursday SET u='$user'");
...
$check = mysql_query("SELECT v FROM thursday WHERE id='1'");

if (!$check == ''){

mysql_query("UPDATE thursday SET v='$user'");
...
$check = mysql_query("SELECT w FROM thursday WHERE id='1'");

if (!$check == ''){

mysql_query("UPDATE thursday SET w='$user'");
...
mysql_query("UPDATE thursday SET a=''");
...
mysql_query("UPDATE thursday SET b=''");
...
mysql_query("UPDATE thursday SET c=''");
...
mysql_query("UPDATE thursday SET d=''");
...
mysql_query("UPDATE thursday SET e=''");
...
mysql_query("UPDATE thursday SET f=''");
...
mysql_query("UPDATE thursday SET x=''");
...
mysql_query("UPDATE thursday SET g=''");
...
mysql_query("UPDATE thursday SET h=''");
...
mysql_query("UPDATE thursday SET i=''");
...
mysql_query("UPDATE thursday SET j=''");
...
mysql_query("UPDATE thursday SET k=''");
...
mysql_query("UPDATE thursday SET l=''");
...
mysql_query("UPDATE thursday SET m=''");
...
mysql_query("UPDATE thursday SET n=''");
...
mysql_query("UPDATE thursday SET o=''");
...
mysql_query("UPDATE thursday SET p=''");
...
mysql_query("UPDATE thursday SET q=''");
...
mysql_query("UPDATE thursday SET r=''");
...
mysql_query("UPDATE thursday SET s=''");
...
mysql_query("UPDATE thursday SET t=''");
...
mysql_query("UPDATE thursday SET u=''");
...
mysql_query("UPDATE thursday SET v=''");
...
mysql_query("UPDATE thursday SET w=''");
...
mysql_query("UPDATE thursday SET a='',b='',c='',d='',e='',f='',g='',h='',i='',j='',k='',l='',m='',n='',o='',p='',q='',r='',s='',t='',u='',v='',w='',x=''");
