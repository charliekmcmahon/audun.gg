...
<script language="JavaScript">
  ...
  function confirm_prompt(text) {
    ...
    if (confirm(text)) {
      ...
      window.location = 'adminfriday.php?update=clear';
    ...
    if (confirm(text)) {
      ...
      window.location = 'adminfriday.php?update=ra';
    ...
    if (confirm(text)) {
      ...
      window.location = 'adminfriday.php?update=rb';
    ...
    if (confirm(text)) {
      ...
      window.location = 'adminfriday.php?update=rc';
    ...
    if (confirm(text)) {
      ...
      window.location = 'adminfriday.php?update=rd';
    ...
    if (confirm(text)) {
      ...
      window.location = 'adminfriday.php?update=re';
    ...
    if (confirm(text)) {
      ...
      window.location = 'adminfriday.php?update=rf';
    ...
    if (confirm(text)) {
      ...
      window.location = 'adminfriday.php?update=rg';
    ...
    if (confirm(text)) {
      ...
      window.location = 'adminfriday.php?update=rx';
    ...
    if (confirm(text)) {
      ...
      window.location = 'adminfriday.php?update=rh';
    ...
    if (confirm(text)) {
      ...
      window.location = 'adminfriday.php?update=ri';
    ...
    if (confirm(text)) {
      ...
      window.location = 'adminfriday.php?update=rj';
    ...
    if (confirm(text)) {
      ...
      window.location = 'adminfriday.php?update=rk';
    ...
    if (confirm(text)) {
      ...
      window.location = 'adminfriday.php?update=rl';
    ...
    if (confirm(text)) {
      ...
      window.location = 'adminfriday.php?update=rm';
    ...
    if (confirm(text)) {
      ...
      window.location = 'adminfriday.php?update=rn';
    ...
    if (confirm(text)) {
      ...
      window.location = 'adminfriday.php?update=ro';
    ...
    if (confirm(text)) {
      ...
      window.location = 'adminfriday.php?update=rp';
    ...
    if (confirm(text)) {
      ...
      window.location = 'adminfriday.php?update=rq';
    ...
    if (confirm(text)) {
      ...
      window.location = 'adminfriday.php?update=rr';
    ...
    if (confirm(text)) {
      ...
      window.location = 'adminfriday.php?update=rs';
    ...
    if (confirm(text)) {
      ...
      window.location = 'adminfriday.php?update=rt';
    ...
    if (confirm(text)) {
      ...
      window.location = 'adminfriday.php?update=ru';
    ...
    if (confirm(text)) {
      ...
      window.location = 'adminfriday.php?update=rv';
    ...
    if (confirm(text)) {
      ...
      window.location = 'adminfriday.php?update=rw';
...
<p align="left" class="heading"><font face="Verdana" size="1"><u><b>Book your Friday Shows</b></u></p></font>
...
cellpadding="2" cellspacing="0">
    ...
    <tr>
      ...
      <td width=100 align="center"><font face="Verdana" size="1">00:00 - 01:00</font></td>
		...
		echo"<a href=adminfriday.php?update=a>&nbsp;Book this Slot</a>";
	...
	<tr>
      ...
      <td width=100 align="center"><font face="Verdana" size="1">01:00 - 02:00</font></td>
		...
		echo"<a href=adminfriday.php?update=b>&nbsp;Book this Slot</a>";
	...
	<tr>
      ...
      <td width=100 align="center"><font face="Verdana" size="1">02:00 - 03:00</font></td>
		...
		echo"<a href=adminfriday.php?update=c>&nbsp;Book this Slot</a>";
	...
	<tr>
      ...
      <td width=100 align="center"><font face="Verdana" size="1">03:00 - 04:00</font></td>
		...
		echo"<a href=adminfriday.php?update=d>&nbsp;Book this Slot</a>";
	...
	<tr>
      ...
      <td width=100 align="center"><font face="Verdana" size="1">04:00 - 05:00</font></td>
		...
		echo"<a href=adminfriday.php?update=e>&nbsp;Book this Slot</a>";
	...
	<tr>
      ...
      <td width=100 align="center"><font face="Verdana" size="1">05:00 - 06:00</font></td>
		...
		echo"<a href=adminfriday.php?update=f>&nbsp;Book this Slot</a>";
	...
	<tr>
      ...
      <td width=100 align="center"><font face="Verdana" size="1">06:00 - 07:00</font></td>
		...
		echo"<a href=adminfriday.php?update=g>&nbsp;Book this Slot</a>";
	...
	<tr>
      ...
      <td width=100 align="center"><font face="Verdana" size="1">07:00 - 08:00</font></td>
		...
		echo"<a href=adminfriday.php?update=x>&nbsp;Book this Slot</a>";
	...
	<tr>
      ...
      <td width=100 align="center"><font face="Verdana" size="1">08:00 - 09:00</font></td>
		...
		echo"<a href=adminfriday.php?update=h>&nbsp;Book this Slot</a>";
	...
	<tr>
      ...
      <td width=100 align="center"><font face="Verdana" size="1">09:00 - 10:00</font></td>
		...
		echo"<a href=adminfriday.php?update=i>&nbsp;Book this Slot</a>";
	...
	<tr>
      ...
      <td width="100" align="center"><font face="Verdana" size="1">10:00 - 11:00</font></td>
		...
		echo"<a href=adminfriday.php?update=j>&nbsp;Book this Slot</a>";
	...
	<tr>
      ...
      <td width=100 align="center"><font face="Verdana" size="1">11:00 - 12:00</font></td>
		...
		echo"<a href=adminfriday.php?update=k>&nbsp;Book this Slot</a>";
	...
	<tr>
      ...
      <td><font face="Verdana" size="1"><?php if($l == ''){
		...
		echo"<a href=adminfriday.php?update=l>&nbsp;Book this Slot</a>";
	...
	<tr>
	  ...
	  <td><font face="Verdana" size="1"><?php if($m == ''){
		...
		echo"<a href=adminfriday.php?update=m>&nbsp;Book this Slot</a>";
	...
	<tr>
      ...
      <td><font face="Verdana" size="1"><?php if($n == ''){
		...
		echo"<a href=adminfriday.php?update=n>&nbsp;Book this Slot</a>";
	...
	<tr>
      ...
      <td><font face="Verdana" size="1"><?php if($o == ''){
		...
		echo"<a href=adminfriday.php?update=o>&nbsp;Book this Slot</a>";
	...
	<tr>
      ...
      <td><font face="Verdana" size="1"><?php if($p == ''){
		...
		echo"<a href=adminfriday.php?update=p>&nbsp;Book this Slot</a>";
	...
	<tr>
      ...
      <td><font face="Verdana" size="1"><?php if($q == ''){
		...
		echo"<a href=adminfriday.php?update=q>&nbsp;Book this Slot</a>";
	...
	<tr>
      ...
      <td width=100 align="center"><font face="Verdana" size="1">18:00 - 19:00</font></td>
		...
		echo"<a href=adminfriday.php?update=r>&nbsp;Book this Slot</a>";
	...
	<tr>
      ...
      <td><font face="Verdana" size="1"><?php if($s == ''){
		...
		echo"<a href=adminfriday.php?update=s>&nbsp;Book this Slot</a>";
	...
	<tr>
      ...
      <td><font face="Verdana" size="1"><?php if($t == ''){
		...
		echo"<a href=adminfriday.php?update=t>&nbsp;Book this Slot</a>";
	...
	<tr>
      ...
      <td width=100 align="center"><font face="Verdana" size="1">21:00 - 22:00</font></td>
		...
		echo"<a href=adminfriday.php?update=u>&nbsp;Book this Slot</a>";
	...
	<tr>
      ...
      <td width=100 align="center"><font face="Verdana" size="1">22:00 - 23:00</font></td>
		...
		echo"<a href=adminfriday.php?update=v>&nbsp;Book this Slot</a>";
	...
	<tr>
      ...
      <td width=100 align="center"><font face="Verdana" size="1">23:00 - 00:00</font></td>
		...
		echo"<a href=adminfriday.php?update=w>&nbsp;Book this Slot</a>";
...
$check = mysql_query("SELECT a FROM friday WHERE id='1'");

if (!$check == ''){

mysql_query("UPDATE friday SET a='$user'");

echo "<script language=\"javascript\">

<!-- 

location.replace(\"adminfriday.php\");
...
$check = mysql_query("SELECT b FROM friday WHERE id='1'");

if (!$check == ''){

mysql_query("UPDATE friday SET b='$user'");
...
$check = mysql_query("SELECT c FROM friday WHERE id='1'");

if (!$check == ''){

mysql_query("UPDATE friday SET c='$user'");
...
$check = mysql_query("SELECT d FROM friday WHERE id='1'");

if (!$check == ''){

mysql_query("UPDATE friday SET d='$user'");
...
$check = mysql_query("SELECT e FROM friday WHERE id='1'");

if (!$check == ''){

mysql_query("UPDATE friday SET e='$user'");
...
$check = mysql_query("SELECT f FROM friday WHERE id='1'");

if (!$check == ''){

mysql_query("UPDATE friday SET f='$user'");
...
$check = mysql_query("SELECT g FROM friday WHERE id='1'");

if (!$check == ''){

mysql_query("UPDATE friday SET g='$user'");
...
$check = mysql_query("SELECT x FROM friday WHERE id='1'");

if (!$check == ''){

mysql_query("UPDATE friday SET x='$user'");
...
$check = mysql_query("SELECT h FROM friday WHERE id='1'");

if (!$check == ''){

mysql_query("UPDATE friday SET h='$user'");
...
$check = mysql_query("SELECT i FROM friday WHERE id='1'");

if (!$check == ''){

mysql_query("UPDATE friday SET i='$user'");
...
$check = mysql_query("SELECT j FROM friday WHERE id='1'");

if (!$check == ''){

mysql_query("UPDATE friday SET j='$user'");
...
$check = mysql_query("SELECT k FROM friday WHERE id='1'");

if (!$check == ''){

mysql_query("UPDATE friday SET k='$user'");
...
$check = mysql_query("SELECT l FROM friday WHERE id='1'");

if (!$check == ''){

mysql_query("UPDATE friday SET l='$user'");
...
$check = mysql_query("SELECT m FROM friday WHERE id='1'");

if (!$check == ''){

mysql_query("UPDATE friday SET m='$user'");
...
$check = mysql_query("SELECT n FROM friday WHERE id='1'");

if (!$check == ''){

mysql_query("UPDATE friday SET n='$user'");
...
$check = mysql_query("SELECT o FROM friday WHERE id='1'");

if (!$check == ''){

mysql_query("UPDATE friday SET o='$user'");
...
$check = mysql_query("SELECT p FROM friday WHERE id='1'");

if (!$check == ''){

mysql_query("UPDATE friday SET p='$user'");
...
$check = mysql_query("SELECT q FROM friday WHERE id='1'");

if (!$check == ''){

mysql_query("UPDATE friday SET q='$user'");
...
$check = mysql_query("SELECT r FROM friday WHERE id='1'");

if (!$check == ''){

mysql_query("UPDATE friday SET r='$user'");
...
$check = mysql_query("SELECT s FROM friday WHERE id='1'");

if (!$check == ''){

mysql_query("UPDATE friday SET s='$user'");
...
$check = mysql_query("SELECT t FROM friday WHERE id='1'");

if (!$check == ''){

mysql_query("UPDATE friday SET t='$user'");
...
$check = mysql_query("SELECT u FROM friday WHERE id='1'");

if (!$check == ''){

mysql_query("UPDATE friday SET u='$user'");
...
$check = mysql_query("SELECT v FROM friday WHERE id='1'");

if (!$check == ''){

mysql_query("UPDATE friday SET v='$user'");
...
$check = mysql_query("SELECT w FROM friday WHERE id='1'");

if (!$check == ''){

mysql_query("UPDATE friday SET w='$user'");
...
mysql_query("UPDATE friday SET a=''");
...
mysql_query("UPDATE friday SET b=''");
...
mysql_query("UPDATE friday SET c=''");
...
mysql_query("UPDATE friday SET d=''");
...
mysql_query("UPDATE friday SET e=''");
...
mysql_query("UPDATE friday SET f=''");
...
mysql_query("UPDATE friday SET x=''");
...
mysql_query("UPDATE friday SET g=''");
...
mysql_query("UPDATE friday SET h=''");
...
mysql_query("UPDATE friday SET i=''");
...
mysql_query("UPDATE friday SET j=''");
...
mysql_query("UPDATE friday SET k=''");
...
mysql_query("UPDATE friday SET l=''");
...
mysql_query("UPDATE friday SET m=''");
...
mysql_query("UPDATE friday SET n=''");
...
mysql_query("UPDATE friday SET o=''");
...
mysql_query("UPDATE friday SET p=''");
...
mysql_query("UPDATE friday SET q=''");
...
mysql_query("UPDATE friday SET r=''");
...
mysql_query("UPDATE friday SET s=''");
...
mysql_query("UPDATE friday SET t=''");
...
mysql_query("UPDATE friday SET u=''");
...
mysql_query("UPDATE friday SET v=''");
...
mysql_query("UPDATE friday SET w=''");
...
mysql_query("UPDATE friday SET a='',b='',c='',d='',e='',f='',g='',h='',i='',j='',k='',l='',m='',n='',o='',p='',q='',r='',s='',t='',u='',v='',w='',x=''");
