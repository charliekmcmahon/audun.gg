...
<p align="left" class="heading"><b><u>Book your Sunday Shows</u></b></p>
...
cellpadding="2" cellspacing="0">
    <tr>
      ...
      <td width="100" align="center">00:00 - 01:00</td>
		<td><?php if($a == ''){
		echo"<a href=djsunday.php?update=a>&nbsp;Book this Slot</a>";
		}
		else{
                $num = mysql_numrows($result);
                $i = 0;
                ...
                if ($user == $check){
		echo "<a href=djsunday.php?update=ra>&nbsp;$a</a>";
		}
		else{
                echo "$a";
               }
	...
	<tr>
      ...
      <td width="100" align="center">01:00 - 02:00</td>
		<td><?php if($b == ''){
		echo"<a href=djsunday.php?update=b>&nbsp;Book this Slot</a>";
		}
		else{
                $num = mysql_numrows($result);
                $i = 0;
                ...
                if ($user == $check){
		echo "<a href=djsunday.php?update=rb>&nbsp;$b</a>";
		}
                else{
                echo "$b";
               }
	...
	<tr>
      ...
      <td width="100" align="center">02:00 - 03:00</td>
		<td><?php if($c == ''){
		echo"<a href=djsunday.php?update=c>&nbsp;Book this Slot</a>";
		}
		else{
                $num = mysql_numrows($result);
                $i = 0;
                ...
                if ($user == $check){
		echo "<a href=djsunday.php?update=rc>&nbsp;$c</a>";
		}
                else{
                echo "$c";
               }
	...
	<tr>
      ...
      <td width="100" align="center">03:00 - 04:00</td>
		<td><?php if($d == ''){
		echo"<a href=djsunday.php?update=d>&nbsp;Book this Slot</a>";
		}
		else{
                $num = mysql_numrows($result);
                $i = 0;
                ...
                if ($user == $check){
		echo "<a href=djsunday.php?update=rd>&nbsp;$d</a>";
		}
                else{
                echo "$d";
               }
	...
	<tr>
      ...
      <td width="100" align="center">04:00 - 05:00</td>
		<td><?php if($e == ''){
		echo"<a href=djsunday.php?update=e>&nbsp;Book this Slot</a>";
		}
		else{
                $num = mysql_numrows($result);
                $i = 0;
                ...
                if ($user == $check){
		echo "<a href=djsunday.php?update=re>&nbsp;$e</a>";
		}
                else{
                echo "$e";
               }
	...
	<tr>
      ...
      <td width="100" align="center">05:00 - 06:00</td>
		<td><?php if($f == ''){
		echo"<a href=djsunday.php?update=f>&nbsp;Book this Slot</a>";
		}
		else{
                $num = mysql_numrows($result);
                $i = 0;
                ...
                if ($user == $check){
		echo "<a href=djsunday.php?update=rf>&nbsp;$f</a>";
		}
                else{
                echo "$f";
               }
	...
	<tr>
      ...
      <td width="100" align="center">06:00 - 07:00</td>
		<td><?php if($g == ''){
		echo"<a href=djsunday.php?update=g>&nbsp;Book this Slot</a>";
		}
		else{
                $num = mysql_numrows($result);
                $i = 0;
                ...
                if ($user == $check){
		echo "<a href=djsunday.php?update=rg>&nbsp;$g</a>";
		}
                else{
                echo "$g";
               }
	...
	<tr>
      ...
      <td width="100" align="center">07:00 - 08:00</td>
		<td><?php if($x == ''){
		echo"<a href=djsunday.php?update=x>&nbsp;Book this Slot</a>";
		}
		else{
                $num = mysql_numrows($result);
                $i = 0;
                ...
                if ($user == $check){
		echo "<a href=djsunday.php?update=rx>&nbsp;$x</a>";
		}
                else{
                echo "$x";
               }
	...
	<tr>
      ...
      <td width="100" align="center">08:00 - 09:00</td>
		<td><?php if($h == ''){
		echo"<a href=djsunday.php?update=h>&nbsp;Book this Slot</a>";
		}
		else{
                $num = mysql_numrows($result);
                $i = 0;
                ...
                if ($user == $check){
		echo "<a href=djsunday.php?update=rh>&nbsp;$h</a>";
		}
                else{
                echo "$h";
               }
	...
	<tr>
      ...
      <td width="100" align="center">09:00 - 10:00</td>
		<td><?php if($ti == ''){
		echo"<a href=djsunday.php?update=ti>&nbsp;Book this Slot</a>";
		}
		else{
                $num = mysql_numrows($result);
                $i = 0;
                ...
                if ($user == $check){
		echo "<a href=djsunday.php?update=ri>&nbsp;$ti</a>";
		}
                else{
                echo "$ti";
               }
	...
	<tr>
      ...
      <td width="100" align="center">10:00 - 11:00</td>
		<td><?php if($j == ''){
		echo"<a href=djsunday.php?update=j>&nbsp;Book this Slot</a>";
		}
		else{
                $num = mysql_numrows($result);
                $i = 0;
                ...
                if ($user == $check){
		echo "<a href=djsunday.php?update=rj>&nbsp;$j</a>";
		}
                else{
                echo "$j";
               }
	...
	<tr>
      ...
      <td width="100" align="center">11:00 - 12:00</td>
		<td><?php if($k == ''){
		echo"<a href=djsunday.php?update=k>&nbsp;Book this Slot</a>";
		}
		else{
                $num = mysql_numrows($result);
                $i = 0;
                ...
                if ($user == $check){
		echo "<a href=djsunday.php?update=rk>&nbsp;$k</a>";
		}
                else{
                echo "$k";
               }
	...
	<tr>
     ...
     <td><?php if($l == ''){
		echo"<a href=djsunday.php?update=l>&nbsp;Book this Slot</a>";
		}
		else{
                $num = mysql_numrows($result);
                $i = 0;
                ...
                if ($user == $check){
		echo "<a href=djsunday.php?update=rl>&nbsp;$l</a>";
		}
                else{
                echo "$l";
               }
	...
	<tr>
	  ...
	  <td><?php if($m == ''){
		echo"<a href=djsunday.php?update=m>&nbsp;Book this Slot</a>";
		}
		else{
                $num = mysql_numrows($result);
                $i = 0;
                ...
                if ($user == $check){
		echo "<a href=djsunday.php?update=rm>&nbsp;$m</a>";
		}
                else{
                echo "$m";
               }
	...
	<tr>
      ...
      <td><?php if($n == ''){
		echo"<a href=djsunday.php?update=n>&nbsp;Book this Slot</a>";
		}
		else{
                $num = mysql_numrows($result);
                $i = 0;
                ...
                if ($user == $check){
		echo "<a href=djsunday.php?update=rn>&nbsp;$n</a>";
		}
                else{
                echo "$n";
               }
	...
	<tr>
      ...
      <td><?php if($o == ''){
		echo"<a href=djsunday.php?update=o>&nbsp;Book this Slot</a>";
		}
		else{
                $num = mysql_numrows($result);
                $i = 0;
                ...
                if ($user == $check){
		echo "<a href=djsunday.php?update=ro>&nbsp;$o</a>";
		}
                else{
                echo "$o";
               }
	...
	<tr>
      ...
      <td><?php if($p == ''){
		echo"<a href=djsunday.php?update=p>&nbsp;Book this Slot</a>";
		}
		else{
                $num = mysql_numrows($result);
                $i = 0;
                ...
                if ($user == $check){
		echo "<a href=djsunday.php?update=rp>&nbsp;$p</a>";
		}
                else{
                echo "$p";
               }
	...
	<tr>
      ...
      <td><?php if($q == ''){
		echo"<a href=djsunday.php?update=q>&nbsp;Book this Slot</a>";
		}
		else{
                $num = mysql_numrows($result);
                $i = 0;
                ...
                if ($user == $check){
		echo "<a href=djsunday.php?update=rq>&nbsp;$q</a>";
		}
                else{
                echo "$q";
               }
	...
	<tr>
      ...
      <td width="100" align="center">18:00 - 19:00</td>
		<td><?php if($r == ''){
		echo"<a href=djsunday.php?update=r>&nbsp;Book this Slot</a>";
		}
		else{
                $num = mysql_numrows($result);
                $i = 0;
                ...
                if ($user == $check){
		echo "<a href=djsunday.php?update=rr>&nbsp;$r</a>";
		}
                else{
                echo "$r";
               }
	...
	<tr>
      ...
      <td><?php if($s == ''){
		echo"<a href=djsunday.php?update=s>&nbsp;Book this Slot</a>";
		}
		else{
                $num = mysql_numrows($result);
                $i = 0;
                ...
                if ($user == $check){
		echo "<a href=djsunday.php?update=rs>&nbsp;$s</a>";
		}
                else{
                echo "$s";
               }
	...
	<tr>
      ...
      <td><?php if($t == ''){
		echo"<a href=djsunday.php?update=t>&nbsp;Book this Slot</a>";
		}
		else{
                $num = mysql_numrows($result);
                $i = 0;
                ...
                if ($user == $check){
		echo "<a href=djsunday.php?update=rt>&nbsp;$t</a>";
		}
                else{
                echo "$t";
               }
	...
	<tr>
      ...
      <td width="100" align="center">21:00 - 22:00</td>
		<td><?php if($u == ''){
		echo"<a href=djsunday.php?update=u>&nbsp;Book this Slot</a>";
		}
		else{
                $num = mysql_numrows($result);
                $i = 0;
                ...
                if ($user == $check){
		echo "<a href=djsunday.php?update=ru>&nbsp;$u</a>";
		}
                else{
                echo "$u";
               }
	...
	<tr>
      ...
      <td width="100" align="center">22:00 - 23:00</td>
		<td><?php if($v == ''){
		echo"<a href=djsunday.php?update=v>&nbsp;Book this Slot</a>";
		}
		else{
                $num = mysql_numrows($result);
                $i = 0;
                ...
                if ($user == $check){
		echo "<a href=djsunday.php?update=rv>&nbsp;$v</a>";
		}
                else{
                echo "$v";
               }
	...
	<tr>
      ...
      <td width="100" align="center">23:00 - 00:00</td>
		<td><?php if($w == ''){
		echo"<a href=djsunday.php?update=w>&nbsp;Book this Slot</a>";
		}
		else{
                $num = mysql_numrows($result);
                $i = 0;
                ...
                if ($user == $check){
		echo "<a href=djsunday.php?update=rw>&nbsp;$w</a>";
		}
                else{
                echo "$w";
               }
